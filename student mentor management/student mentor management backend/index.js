...
//4. Get UnAssigned Student Details
...
//7. Assign or change Mentor for particular Student
app.put('/assignMentorToStudent/:id', async function (req, res) {
    try {
        console.log(req.body);
...
//8. API to show Students of Particular Mentor
